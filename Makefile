# This Makefile is for the Eselsohr extension to perl.
#
...
TO_INST_PM = lib/Eselsohr.pm \
	lib/Eselsohr/Controller/Example.pm

PM_TO_BLIB = lib/Eselsohr.pm \
	blib/lib/Eselsohr.pm \
	lib/Eselsohr/Controller/Example.pm \
	blib/lib/Eselsohr/Controller/Example.pm
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: Eselsohr' >> META_new.yml
	$(NOECHO) $(ECHO) 'no_index:' >> META_new.yml
	$(NOECHO) $(ECHO) '  directory:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - t' >> META_new.yml
	$(NOECHO) $(ECHO) '    - inc' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  Mojolicious: 6.05' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Eselsohr",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "Mojolicious" : "6.05"' >> META_new.json
	$(NOECHO) $(ECHO) '         }' >> META_new.json
	$(NOECHO) $(ECHO) '      }' >> META_new.json
	$(NOECHO) $(ECHO) '   },' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE VERSION="6.05" NAME="Mojolicious::" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Eselsohr.pm blib/lib/Eselsohr.pm \
	  lib/Eselsohr/Controller/Example.pm blib/lib/Eselsohr/Controller/Example.pm 
